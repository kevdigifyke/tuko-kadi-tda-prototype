export function GesturePanel() {
  return (
    <section className="w-full rounded-2xl border border-white/12 bg-[linear-gradient(180deg,rgba(23,32,34,.72),rgba(10,16,19,.93))] p-4 shadow-[0_20px_45px_rgba(0,0,0,.35)] backdrop-blur xl:w-[292px]">
      <h2 className="panel-kicker text-[#00e5ff]">Gesture Control HUD</h2>
      <div className="mt-4 h-28 rounded-md border border-cyan-400/35 bg-[radial-gradient(circle_at_60%_30%,rgba(0,229,255,0.24),transparent_45%),linear-gradient(120deg,#02070c,#0b1620)]" />
